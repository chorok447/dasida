...
**1차 추천안**: Docker Compose on VM + **host Nginx** reverse proxy — [deployment-strategy.md](./deployment-strategy.md), [nginx-reverse-proxy-deployment.md](./nginx-reverse-proxy-deployment.md).
