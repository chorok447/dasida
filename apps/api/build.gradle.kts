...
dependencies {
	...
	// [spike] Jackson 2 kotlin module 제거 — HibernateJsonFormatMapperConfig(Jackson3JsonFormatMapper)로 대체 검증.
	// develop 반영 시 Ready PR로 분리. 상세: docs/backend/hibernate-json-jackson3-formatmapper-check.md
